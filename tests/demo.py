...
from devopsnextgenx.components import Treeview
...
class Demo(ttk.Window):
    ...
    def add_employee_tree(self, parent):
        ...
        rootFrame.pack(fill="both", expand=True, pady=10)
        self.employee_tree = Treeview(rootFrame, items=tree_items)
        self.employee_tree.pack(fill="both", expand=True, pady=10)
